...
| Field | Value |
|-------|-------|
| **Phase** | Phase 1 — Engines Foundation 🔄 IN FLIGHT (Step 1.6 Vortex GC rewrite; packets 1.6.1-1.6.5 SHIPPED, packets 1.6.6-1.6.8 retired to Step 2.8; packets 2.8.1 SHIPPED, 2.8.2 SHIPPED, 2.8.3 SHIPPED; Packet 2.1.1 SHIPPED, Packet 2.1.2 SHIPPED, Packet 2.1.3 SHIPPED, Packet 2.13.1 SHIPPED); **Phase 2 Steps 2.9–2.12 added 2026-06-18 (table-stakes i18n, ADR-0007)** |
